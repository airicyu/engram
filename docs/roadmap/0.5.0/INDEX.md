...
| 16 | 用語 | **operator** → **workbench**；skill 目錄 `engram-workbench`；Recall 中文 **回憶**（不用「召回」）；見 `docs/domain-language.md` |
...
8. `docs/domain-language.md` 補 **ledger**／**summary**
