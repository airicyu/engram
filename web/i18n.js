...
(function (global) {
  ...
  const zh = {
    ...
    "activities.mention_create": "新建節點",
    "activities.mention_create_exists": "此 id 已有節點，請選既有提及",
    "activities.mention_empty_create": "此名稱無法作為節點 id（勿含空白／路徑符號）",
  ...
  const en = {
    ...
    "activities.mention_create": "Create node",
    "activities.mention_create_exists": "That id already exists — pick the existing mention",
    "activities.mention_empty_create": "That name cannot be a node id (no spaces or path characters)",
