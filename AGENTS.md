...
`version.md` 現行 **0.5.0**。近期出貨：[0.4.0 Import](docs/roadmap/0.4.0/INDEX.md)、[0.5.0 UI 還原](docs/roadmap/0.5.0/INDEX.md)（`shipped`）、[0.3.3 Engram 對齊](docs/roadmap/0.3.3/INDEX.md)（`shipped`）。規劃中：[0.3.0](docs/roadmap/0.3.0/INDEX.md)（`planned`）。殼層剩餘見 [backlog/ui-shell-remainder](docs/roadmap/backlog/ui-shell-remainder.md)。契約延伸：[0.3.0](docs/roadmap/0.3.0/INDEX.md)（`planned`；根目錄 `docs/data-spec.md`／`docs/api.md` 已對齊該 INDEX）。執行某版：`.agents/skills/roadmap-version`。上游：[0.2.0](docs/roadmap/0.2.0/INDEX.md)（`shipped`）、[0.1.0](docs/roadmap/0.1.0/INDEX.md)（`shipped`）。寫 roadmap：[GUIDELINES.md](docs/roadmap/GUIDELINES.md)。未排程：[backlog](docs/roadmap/backlog/INDEX.md)。
